        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Chantez vos chansons préférées dans nos <strong className="font-bold">salles privées</strong> équipées du dernier système karaoké. Parfait pour les anniversaires, soirées entre amis ou événements d'entreprise.
            </p>
