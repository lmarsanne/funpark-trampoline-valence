        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-lg text-muted-foreground mb-12">
              Tarif par personne • Session d'environ 1h • Réservation obligatoire
            </p>

            <div className="flex justify-center mb-12">
              <div className="bg-card rounded-2xl p-8 shadow-xl border-2 border-primary relative overflow-hidden max-w-md w-full">
                <div className="absolute top-0 left-0 right-0 bg-primary text-primary-foreground text-sm font-bold px-4 py-2 text-center">
                  🔥 OFFRE DE LANCEMENT
                </div>
                <div className="text-center mt-8 mb-6">
                  <div className="flex justify-center items-baseline gap-3">
                    <span className="text-3xl text-muted-foreground line-through">20€</span>
                    <span className="text-6xl font-bold text-primary">10€</span>
                    <span className="text-xl text-muted-foreground">/ personne</span>
                  </div>
                </div>

                <p className="text-center text-sm font-semibold text-primary mb-2">
                  Soit 50% de remise — Offre valable cette semaine
                </p>

                <div className="bg-muted rounded-xl p-4 mb-6">
                  <p className="text-center text-sm text-muted-foreground">
                    Session d'environ 1h • Réservation obligatoire
                  </p>
                </div>
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">Tarif par personne</h4>
                  <p className="text-sm text-muted-foreground">
                    Le tarif est de 10€ par personne (tarif promotionnel au lieu de 20€). Réservation obligatoire. Session d'environ 1 heure en salle privative.
                  </p>
                </div>
              </div>
            </div>
