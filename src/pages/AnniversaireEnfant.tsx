...
const formulas = [{
  ...
  badge: null,
  badgeColor: "",
  features: ["1h d'Activité Trampoline", "30 min de Goûter (Espace réservé)", "Gâteau, bonbons & boissons inclus", "🧦 Chaussettes offertes"]
}, {
  ...
  features: ["1h de Trampoline", "30 min de Bowling", "30 min de Goûter (Espace réservé)", "Gâteau, bonbons & boissons inclus", "🧦 Chaussettes offertes"]
}, {
  ...
  features: ["1h de Trampoline", "1h de Karaoké (Box Privée)", "30 min de Goûter (Espace réservé)", "Gâteau, bonbons & boissons inclus", "🧦 Chaussettes offertes"]
}, {
  ...
  badge: null,
  badgeColor: "",
  features: ["1h de Trampoline", "30 min de Bowling", "+ 2 Jetons Arcade offerts", "Gâteau, bonbons & boissons inclus", "🧦 Chaussettes offertes"]
}];
const faqItems = [{
